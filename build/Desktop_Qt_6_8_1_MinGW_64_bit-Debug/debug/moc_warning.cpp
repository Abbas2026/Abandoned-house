...
static constexpr auto qt_meta_stringdata_ZN7WarningE = QtMocHelpers::stringData(
    "Warning",
    "on_p_next_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7WarningE[] = {
...
Q_CONSTINIT const QMetaObject Warning::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7WarningE.offsetsAndSizes,
    qt_meta_data_ZN7WarningE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7WarningE_t,
        // Q_OBJECT / Q_GADGET
...
void *Warning::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7WarningE.stringdata0))
